...
function FormSplitBill({ selectFriend, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <label type="text">💰 Bill value</label>
      <input
        type="text"
        value={bill}
      ...
      <label type="text">🧍‍♀️Your expense</label>
      <input
        type="text"
        value={paidByUser}
        onChange={(e) =>
      ...
      <label type="text">🧑‍🤝‍🧑{selectFriend.name}'s expense</label>
      ...
      >
        ...
        <option valur="friend">{selectFriend.name}</option>
      </select>
